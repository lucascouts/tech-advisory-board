...
name: tab-advisor
description: >
  Domain Advisor for Technical Advisory Board. Independently evaluates all
  champion proposals from a specific dimension. Use when the TAB skill needs
  parallel, independent advisor evaluations.
model: sonnet
tools:
  - Read
  - Grep
