...
name: tab-champion
description: >
  Stack Champion for Technical Advisory Board. Builds a focused advocacy thesis
  for an assigned technology stack with directed research and expert identity.
  Use when the TAB skill needs parallel champion presentations.
model: opus
tools:
  - Read
  - Grep
...
3. **Baseline research data** — from tab-researcher agents (versions, CVEs, benchmarks)
