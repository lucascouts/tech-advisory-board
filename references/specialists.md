...
Advisors are launched as **independent subagents** (`tab-advisor`) that evaluate
...
These cards are passed as input to each `tab-advisor` subagent.
...
Each `tab-advisor` subagent receives:
