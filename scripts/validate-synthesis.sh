...
# Modes: fast-trivial, fast-simple, standard, full
...
Arguments:
  mode    One of: fast-trivial, fast-simple, standard, full (default: standard)
...
case "$MODE" in
    ...
    standard|full)
        ...
        ;;
    *)
        echo "Unknown mode: $MODE. Use: fast-trivial, fast-simple, standard, full" >&2
