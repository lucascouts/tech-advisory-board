...
- **D+180:** [Automatic rechallenge trigger — schedule via `schedule-rechallenge` or `CronCreate`]
...
- Complex feature requiring planning and task management -> "To structure this into tasks, consider a planning plugin such as `/epic`"
